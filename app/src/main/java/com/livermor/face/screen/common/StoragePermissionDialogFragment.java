package com.livermor.face.screen.common;
...
public class StoragePermissionDialogFragment extends DialogFragment {
    ...
    public static StoragePermissionDialogFragment newInstance() {
        return new StoragePermissionDialogFragment();
    }

    public StoragePermissionDialogFragment() {
    }
